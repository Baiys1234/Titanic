...
fare_bracket_size = 10 # gap en los que va a dividir cada tarifa. 10, 20, 30, 40
...
survival_table = np.zeros([2,number_of_classes,number_of_price_brackets],float) #2x3x4 ( [female/male] , [1st / 2nd / 3rd class], [4 bins of prices] ).
